...
function admin_load_scripts_option(){
    ...
    wp_enqueue_style( 'hatazu_admin_option_style.css', plugin_dir_url(__FILE__) . 'css/hatazu_admin_option_style.css',array(), '1.0.4', 'all');
...
function hatazu_option_script(){
    ...
    wp_enqueue_style( 'hatazu_option_style', plugin_dir_url(__FILE__) . 'css/hatazu_option_style.css',array(), '1.0.2', 'all');
