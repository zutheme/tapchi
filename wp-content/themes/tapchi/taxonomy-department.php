...
<div class="distance"></div>
   ...
   <div class="main" role="main">
      	...
      	<!-- subheader start -->
      		...
      		<div class="row business-header" style="height: 270px; background: url(<?php echo $theme_options['default_page_banner']['url']; ?>) center top no-repeat; background-size: cover; ">
